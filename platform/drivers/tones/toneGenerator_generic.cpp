...
/*
 * TIM11 interrupt handler, used to manage generation of CTCSS and "beep" tones.
 */
void __attribute__((used)) TIM1_TRG_COM_TIM11_IRQHandler()
{
    TIM11->SR = 0;
...
void toneGen_init()
{
    ...
    TIM11->PSC  = 0;                /* 1:1 prescaler               */
    TIM11->ARR  = 9375;
    TIM11->CNT  = 0;
    TIM11->EGR  = TIM_EGR_UG;       /* Update registers            */
    TIM11->DIER = TIM_DIER_UIE;     /* Interrupt on counter update */
